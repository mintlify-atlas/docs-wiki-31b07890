...
| `exception/` | 15 typed exceptions: not-found, can-not-be-applied, can-not-be-deleted, can-not-be-updated, due-at-disbursement-can-not-be-penalty, must-be-penalty, plus loan-charge and share-charge specific ones |
