...
<Note>
The official supported runtime today is **Java 21**, **PostgreSQL ≥ 18**,
...
optional: "we recommend the use of the self-contained JAR, which transparently
embeds a servlet container using Spring Boot."
</Note>
...
Wired up in `org.apache.fineract.infrastructure.instancemode` (in
`fineract-provider`). The matrix:
