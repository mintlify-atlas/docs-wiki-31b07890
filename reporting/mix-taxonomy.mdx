...
- [Reporting overview](/reporting/overview) — where the MIX engine sits relative to stretchy and Pentaho reports.
...
- [Report mailing job](/reporting/report-mailing-job) — the scheduled email engine, which only knows how to handle stretchy/Pentaho output, not MIX.
