...
| Initialisation | `fineract-cob/src/main/java/org/apache/fineract/cob/common/InitialisationTasklet.java` | Sets `AppUser`, `ActionContext.COB` on the worker thread. |
| Lock acquisition | `fineract-provider/src/main/java/org/apache/fineract/cob/loan/ApplyLoanLockTasklet.java` (extends `fineract-cob/.../common/ApplyCommonLockTasklet.java`) | Inserts `m_loan_account_locks` rows for the partition's loan ids. |
