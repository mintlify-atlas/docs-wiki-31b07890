...
| 6 | Strategy dispatch | `fineract-loan/src/main/java/org/apache/fineract/portfolio/loanaccount/domain/transactionprocessor/LoanTransactionProcessingService.java` | Allocation across installments. |
...
| 9 | GL posting | `fineract-provider/.../service/LoanJournalEntryPoster.java` | `postJournalEntriesForLoanTransaction(...)`. |
