...
| -------------------------- | ----------------------------------- | --------------------------------------------------------------- |
| `chargeCalculation`        | `charge_calculation_enum`           | [`ChargeCalculationType`](https://github.com/apache/fineract/blob/develop/fineract-core/src/main/java/org/apache/fineract/portfolio/charge/domain/ChargeCalculationType.java) — flat vs percentage-of-X |
| `chargePaymentMode`        | `charge_payment_mode_enum`          | [`ChargePaymentMode`](https://github.com/apache/fineract/blob/develop/fineract-core/src/main/java/org/apache/fineract/portfolio/charge/domain/ChargePaymentMode.java) — regular vs account-transfer |
