...
- **`ClientStatus`** (`portfolio/client/domain/ClientStatus.java`) — PENDING (100), ACTIVE (300), TRANSFER_IN_PROGRESS (304), TRANSFER_ON_HOLD (305), CLOSED (600), REJECTED (700), WITHDRAWN (800).
