...
- **File:** `fineract-provider/src/main/java/org/apache/fineract/portfolio/savings/domain/DepositAccountRecurringDetail.java`
...
`SavingsAccountTransactionType`: DEPOSIT (1), WITHDRAWAL (2), INTEREST_POSTING (3), WITHDRAWAL_FEE (4), ANNUAL_FEE (5), WAIVE_CHARGES (6), PAY_CHARGE (7), DIVIDEND_PAYOUT (8), ACCRUAL (10), INITIATE_TRANSFER (12), APPROVE_TRANSFER (13), WITHDRAW_TRANSFER (14), REJECT_TRANSFER (15), WRITTEN_OFF (16), OVERDRAFT_INTEREST (17), WITHHOLD_TAX (18), ESCHEAT (19), AMOUNT_HOLD (20), AMOUNT_RELEASE (21).
